...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/chicken-style.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-content">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link text-white" href="search-chicken-sandwich.php">Chicken Sandwich</a></li>
                    ...
                    <?php 
                        if (!empty($_SESSION['id'])) {
                            ...
                            if ($_SESSION['access_privileges'] == 'admin') {
                                ...
                                echo "<li class='nav-item'><a class='nav-link text-white' href='enter-chicken-sandwich.php'>Enter Chicken Sandwich</a></li>";
                            }
